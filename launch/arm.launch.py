...
def generate_launch_description():
    ...
    xacro_path = os.path.join(pkg_arm_description, 'robots', 'left-walkie-arm.urdf.xacro')
    ...
    hardware_config_file_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(get_package_share_directory('arm_description'), 'config', 'hardware_layout.yaml'),
